...
CREATE TABLE registro (
    ...
    CONSTRAINT registro_funcionario_fkey FOREIGN KEY (id_funcionario) REFERENCES funcionario(id),
    CONSTRAINT registro_pesagem_fkey FOREIGN KEY (id_pesagem) REFERENCES pesagem(id),
    CONSTRAINT registro_aplicacao_fkey FOREIGN KEY (id_aplicacao) REFERENCES aplicacao(id),
    CONSTRAINT registro_ocorrencia_doenca_fkey FOREIGN KEY (id_ocorrencia_doenca) REFERENCES ocorrencia_doenca(id),
    CONSTRAINT registro_reproducao_fkey FOREIGN KEY (id_reproducao) REFERENCES reproducao(id),
    CONSTRAINT registro_gestacao_fkey FOREIGN KEY (id_gestacao) REFERENCES gestacao(id),
    CONSTRAINT registro_parto_fkey FOREIGN KEY (id_parto) REFERENCES parto(id)
);
